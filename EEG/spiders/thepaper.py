...
class ThepaperSpider(scrapy.Spider):
    ...
    base_url2 = 'https://www.thepaper.cn/load_search.jsp?k={}&pagesize=10&searchPre=contentName_0:&orderType=1&pageidx={}'
    base_url = 'https://m.thepaper.cn/load_newsearch.jsp?k={}&f=all_0:&pageidx={}&type=1&_={}'

    conflict_count = 5
    confilt_max = 5

    def __init__(self, bloom=bloomfilter.Bloomfilter(100000, 10), keyword={'百度'}):
        self.bloom = bloom
